                ...
                <div class="cart-tab-3">
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div>
                        <span class="select-self-area" @click="editNum(item, 'sub')">-</span>
                        <span class="select-ipt">{{ item.productNum }}</span>
                        <span class="select-self-area" @click="editNum(item, 'add')">+</span>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editNum (item, flag) {
        if (flag === 'add') {
          if (item.productNum < 10) {
            item.productNum++
            axios.post('/users/cartList/editNum', {productId: item.productId, productNum: item.productNum})
          }
        } else if (flag === 'sub') {
